...
class RecViewHolderLibraryReviewsAdapter(inflater: LayoutInflater, val parent: ViewGroup) :
    RecyclerView.ViewHolder(inflater.inflate(R.layout.layout_rv_library_reviews, parent, false)) {
    ...
    fun bindData(rating: String, image: String, title: String, text: String, id: String, forumID: Int) {
        title_tv?.text = title
        text_tv?.text = text
